...
import { getInventoryValuation } from "@/domains/reports/services/report-actions";
  ...
  return (
    <AppShell>
      <ReportPageContent
        ...
        description="Stock value calculated by cost method"
        columns={columns}
        fetcher={getInventoryValuation}
        showWarehouse={true}
        showCustomer={false}
        showSupplier={false}
        showSearch={true}
