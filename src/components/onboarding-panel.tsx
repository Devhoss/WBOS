...
import { ArrowUpRight, Building2, CheckCircle2, Package, Truck, UserPlus, X } from "lucide-react";
  ...
  if (dismissed) {
    return (
      <button
        ...
        className="flex w-full items-center gap-2 rounded-lg border bg-card px-4 py-2.5 text-left text-sm transition hover:bg-muted/60"
      >
